...
- (BOOL)tabBarController:(UITabBarController *)tabBarController shouldSelectViewController:(UIViewController *)viewController {
    if (viewController == tabBarController.viewControllers[2]) {
        ...
        SYANavitationController *publishNavVC = [[SYANavitationController alloc] initWithRootViewController:publishVC];
        [viewController presentViewController:publishNavVC animated:YES completion:^{
